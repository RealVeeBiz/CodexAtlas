--[[
    VeeBiiz Physical Items — Item Definitions

    Register physical item behaviour here. Inventory item names should match
    ox_inventory item names. Extensions may also call RegisterItem at runtime.
]]
...
local function define(name, def)
    ...
    def.permissions = def.permissions or { ownership = 'public' }
...
-- ─────────────────────────────────────────────
-- Bartender example items (extension-friendly)
-- ─────────────────────────────────────────────
...
define('whisky', {
    ...
    permissions = { ownership = 'job', job = 'bartender' },
